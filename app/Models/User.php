...
{
    use HasFactory, Notifiable, HasApiTokens; // El ApiTokens sirve para comprobar el JWT

    protected $guarded = []; // Indica que los demás campos hay que rellenarlos (first_name, etc...)
