        ...
        try {
            ...
            foreach ($request->input('products') as $item) {
                ...
                $lineItems[] = [
                    ...
                    'amount' => 100 * $product->price, // amount viene en centimos
                    'currency' => 'usd',
                    'quantity' => $item['quantity']
                ];
            }

            $stripe = Stripe::make(env('STRIPE_SECRET')); // Secret en el backend y Public en el frontend

            $source = $stripe->checkout()->sessions()->create([
                'payment_method_types' => ['card'],
                'line_items' => $lineItems, // Productos que vamos a comprar
